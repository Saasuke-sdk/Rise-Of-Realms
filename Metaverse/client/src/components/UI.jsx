    ...
    if (userid) {
      try {
        ...
        if (data.username) {
          ...
          window.location.href = `http://localhost/multiplayer.html??username=${address}&address=${userid}`;
          console.log(`http://localhost/multiplayer.html??username=${address}&address=${userid}`);
        } else {
